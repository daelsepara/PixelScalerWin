// hq2x.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const char* FilterName = "HQ 2X";
	const char* FilterDescription = "Maxim Stepin's High Quality 2X Magnification";
