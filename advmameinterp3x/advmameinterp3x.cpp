// advmameinterp3x.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const char* FilterName = "AdvanceMame 3X";
	const char* FilterDescription = "AdvanceMame 3X scaling using interpolation";
