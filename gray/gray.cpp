// gray.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const char* FilterName = "Gray Scale";
	const char* FilterDescription = "Convert image to gray";
		...
		if (argc >= 3)
		{
			...
			for (auto y = 0; y < srcy; y++)
			{
				for (auto x = 0; x < srcx; x++)
				{
					...
					ScaledImage[index] = G;
					ScaledImage[index + 1] = G;
					ScaledImage[index + 2] = G;
				}
			}
		}
	}
