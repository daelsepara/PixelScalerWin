// hq4xbold.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const int FilterID = 0x5D3D;
	const char* FilterName = "HQ 4X Bold";
	const char* FilterDescription = "SNES HQ4X Scaling with Brightness";
