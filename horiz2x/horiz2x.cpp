// horiz2x.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const char* FilterName = "Horizontal Scanlines 2X";
	const char* FilterDescription = "Horizontal Scanlines 2X";
