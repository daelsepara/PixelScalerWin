// hq3x.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const char* FilterName = "HQ 3X";
	const char* FilterDescription = "Maxim Stepin's High Quality 3X Magnification";
