// hq3xbold.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const int FilterID = 0x5D3C;
	const char* FilterName = "HQ 3X Bold";
	const char* FilterDescription = "SNES HQ3X Scaling with Brightness";
