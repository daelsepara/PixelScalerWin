// hq2x3bold.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const int FilterID = 0x5D3E;
	const char* FilterName = "HQ 2X3 Bold";
	const char* FilterDescription = "SNES HQ2X3 Scaling with Brightness";
