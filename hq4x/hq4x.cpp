// hq4x.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const char* FilterName = "HQ 4X";
	const char* FilterDescription = "Maxim Stepin's High Quality 4X Magnification";
