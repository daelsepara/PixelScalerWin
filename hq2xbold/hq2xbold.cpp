// hq2xbold.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const int FilterID = 0x5D3B;
	const char* FilterName = "HQ 2X Bold";
	const char* FilterDescription = "SNES HQ2X Scaling with Brightness";
