// hq2x4bold.cpp : Defines the exported functions for the DLL application.
//
...
extern "C"
{
	...
	const int FilterID = 0x5D3F;
	const char* FilterName = "HQ 2X4 Bold";
	const char* FilterDescription = "SNES HQ2X4 Scaling with Brightness";
